export const metadata = {
  title: 'WTF Links',
  description: 'What are WTF Links?',
};
...
If you navigate to [interweb.wtf/go/patient-recipe/info](https://www.interweb.wtf/go/patient-recipe/info), you will be presented with an information page that allows you to preview what that WTF Link points to.
