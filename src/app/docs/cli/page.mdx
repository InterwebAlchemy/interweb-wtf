...
The Interweb.WTF API uses an Authorization HTTP Header with a [Bearer Token](https://swagger.io/docs/specification/v3_0/authentication/bearer-authentication/).
